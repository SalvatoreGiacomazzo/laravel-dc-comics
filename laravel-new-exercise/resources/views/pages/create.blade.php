...
@endif
        <div class="col-12">
          ...
          @csrf
                  ...
                  <input type="text" class="form-control" id="album_name" name="album_name" value="{{old('album_name')}}" required>
                  ...
                  <div class="col-auto">
                    ...
                    <input type="number" min="1900" max="2024" class="form-control" id="drop_year" name="drop_year" value="{{old('drop_year')}}" required>
                  ...
                  <div class="col-auto">
                    ...
                    <input type="text" class="form-control" id="img_Url" name="img_Url" value="{{old('img_Url')}}" required>
